...
latex_documents = [
    (main_doc, 'flakeheaven.tex', 'FlakeHeaven Documentation',
     '@orsinium', 'manual'),
]
...
man_pages = [(main_doc, 'flakeheaven', 'FlakeHeaven Documentation', [author], 1)]
...
texinfo_documents = [
    (main_doc, 'flakeheaven', 'FlakeHeaven Documentation',
